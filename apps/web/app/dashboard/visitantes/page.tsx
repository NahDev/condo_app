...
export default function VisitantesPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      toast.erro(err instanceof ApiError ? err.message : "Não foi possível registrar a entrada.");
    } finally {
      setEnviando(false);
    }
  }
  ...
  async function handleSaida(id: string) {
    try {
      ...
      toast.erro(err instanceof ApiError ? err.message : "Não foi possível registrar a saída.");
    }
  }
              ...
              {dentroDoCondominio.length === 0 && (
                <li>
                  <EmptyState
                    ...
                    titulo="Nenhum visitante no condomínio."
                    podeCriar={podeRegistrar}
                    dicaCriacao="Use o formulário acima para registrar uma entrada."
                  />
                </li>
              )}
            </ul>
